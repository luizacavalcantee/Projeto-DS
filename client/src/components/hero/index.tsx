    ...
    return (
        <section className="w-full flex items-center text-white">
            <Image
                ...
                fill
                className="object-cover object-center z-0 h-[587px]"
                priority
            />
            <div className="h-[600px] md:h-[700px] lg:h-[800px] relative z-20 px-4 md:px-8 lg:px-8 xl:px-16 max-w-7xl flex flex-col justify-center mt-[-110px] md:mt-[-190px] lg:mt-[-260px]">
                ...
                <p className="text-base mb-8 max-w-2xl">
                    ...
                    projetos e fortalece quem já está transformando comunidades. <br/><span className='font-extrabold'>Junte-se
                    a essa rede e faça parte da mudança.</span>
                </p>

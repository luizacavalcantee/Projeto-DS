      ...
      <div className="w-full px-4 flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-10 md:gap-20 w-full max-w-6xl">
          <div className="text-center flex-1">
            ...
            <span className="text-white font-semibold block mt-2">Escolas Engajadas</span>
          </div>
          <div className="text-center flex-1">
            <span className="text-6xl font-bold text-white block">20+</span>
            <span className="text-white font-semibold block mt-2">ONGs impactadas</span>
          </div>
          <div className="text-center flex-1">
            <span className="text-6xl font-bold text-white block">150+</span>
            <span className="text-white font-semibold block mt-2">Desafios Concluídos</span>
          </div>
          <div className="text-center flex-1">
            <span className="text-6xl font-bold text-white block">10K+</span>
            <span className="text-white font-semibold block mt-2">Estudantes Impactados</span>
          </div>
        </div>
      </div>
    </section>

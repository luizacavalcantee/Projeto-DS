...
export default function ChallengePage() {
  ...
  const escolas = Array.from(
    new Set(mockChallenges.map((challenge) => challenge.escola))
  );
        ...
        <div className="container mx-auto px-8 py-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              ...
              aprendizado e ação para transformar vidas de verdade! Crie um novo
              desafio clicando no botão abaixo.
            </p>
          </div>
          <div>
